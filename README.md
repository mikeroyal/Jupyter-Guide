...
#### A guide covering Jupyter including the applications, libraries and tools that will make you better and more efficient with Jupyter development.
...
[Jupyter](https://jupyter.org) is an open-source software, open standards, and services for interactive computing across dozens of programming languages. Checkout, [Jupyter Documentation](https://jupyter.org/documentation) for more information & examples.
...
[Jupyter Themes](https://github.com/dunovank/jupyter-themes) is a set of custom Jupyter Notebook Themes.
